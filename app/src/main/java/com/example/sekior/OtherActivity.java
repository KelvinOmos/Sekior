...
public class OtherActivity extends AppCompatActivity {
    ...
    String email, phoneNumber,longitude, latitude, comment;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        btnSelectImage = findViewById(R.id.btnSelectImageOther);
        ...
        btnNext = findViewById(R.id.btnNextOther);
                ...
                showWarning(new DialogInterface.OnClickListener() {
                    ...
                    public void onClick(DialogInterface dialogInterface, int i) {
                        try {
                            ...
                            locationTrack = new LocationTrack(OtherActivity.this);
    ...
    private HttpResponse callApi() throws JSONException, UnirestException {
        ...
        geocoder = new Geocoder(OtherActivity.this, Locale.getDefault());

        try {
            addresses = geocoder.getFromLocation(Double.parseDouble(latitude), Double.parseDouble(longitude), 1); // Here 1 represent max location result to returned, by documents it recommended 1 to 5
        } catch (IOException e) {
            e.printStackTrace();
            Toast.makeText(OtherActivity.this, "Please enable location", Toast.LENGTH_SHORT).show();
        }

        String address = addresses.get(0).getAddressLine(0); // If any additional address line present than only, check with max available address lines by getMaxAddressLineIndex()

        String imageString = imageBytes != null ? Base64.encodeToString(imageBytes, Base64.DEFAULT) : "";
        ...
        String url = "http://102.223.37.26:7833/api/Duress/othermsg";
