package com.example.sekior.utils;
...
//                Toast.makeText(mContext, "Location turned on", Toast.LENGTH_LONG).show();
//            }
//        });
//
...
//                Toast.makeText(mContext, "Location turned off", Toast.LENGTH_LONG).show();
//                if (e instanceof ResolvableApiException) {
//                    try {
//                        ResolvableApiException resolvableApiException = (ResolvableApiException) e;
//                        resolvableApiException.startResolutionForResult(null,
